...
export const darkTheme = {
  ...
  "search-input-filter-bg": "#212121ed",
  "scrollbar-bg": "#0a0e13",
...
export const lightTheme = {
  ...
  "default-bg": "#f0f2f5",
  "evidence-box": "#757575",
  "evidence-box-header": "#ffffff",
  "filters-container-bg": "#f0f2f5",
  ...
  "item-hover": "#f2f2f2",
  "light-dark-bg-hover": "#ffffff",
  "medium-dark-bg-hover": "#ffffff",
  "nav-fixed-option-bg-hover": "#d8dadf",
  "nav-fixed-option-bg-extended": "#e7f3ff",
  "sidebar-li-hover": "rgba(0,0,0,0.05)",
  "tab-bg-hover": "rgb(0 0 0 / 30%)",
  // Disabled
  "dark-disabled-button-bg": "#f0f2f5",
  "dark-disabled-button-bg-after": "#f2f2f2",
  "dark-disabled-button-bg-before": "#f0f0f0",
  "disabled-input-bg": "#ffffff",
